...
namespace NeuralNetwork1
{
    public class StudentNetwork : BaseNetwork
    {
        ...
        public StudentNetwork(int [] structure, double lowRandomBound=-1, double upRandomBound=1)
        {
            ...
            for(int n = 0; n < structure.Length-1; n++)
            {
                ...
                for(int i = 0; i < rowsCount; i++)
                {
                    ...
                    {
                        _weights[n][i, j] = random.NextDouble() * (upRandomBound - lowRandomBound) + lowRandomBound;
                    }
                }
            }
        }
        ...
        private void ComputeValues(double[] input)
        {
        ...
        private void ComputeErrors(double[] output)
        {
